...
use rmrfrs_lib::{clean, pretty_size, scan, ScanOptions};
...
fn main() {
    let window = WindowDesc::new(make_ui)
        .title(LocalizedString::new("rmrfrs-main-window-title").with_placeholder("rmrfrs 🧹"))
...
fn make_ui() -> impl Widget<AppData> {
...

    {
        ...
        root.add_child(
            Label::new("See the source, report a bug, or contribute at https://github.com/trinhminhtriet/rmrfrs 🎉")
                .with_text_size(18.0)
                .padding(10.0)
                .center()
        )
